  ...
  return (
    <section className="w-full max-w-2xl mx-auto mt-8">
      <ul className="space-y-2">
        <li className="relative flex flex-col  bg-white/80 backdrop-blur rounded-xl shadow p-4 border border-black/20 transition">
          <div className="flex  items-center  justify-between">
            ...
            <button
              ...
              type="button"
              disabled={data.isRemoving}
              className={`cursor-pointer p-2 rounded-full bg-red-100 hover:bg-red-200 transition ${data.isRemoving ? "opacity-60 pointer-events-none" : ""}`}
          ...
          <div className="mx-auto text-[20px] cursor-grab active:cursor-grabbing transition-all-0.3s">=</div>
        </li>
      </ul>
    </section>
  );
